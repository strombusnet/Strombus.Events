...
namespace Strombus.Events
{
    public sealed class Singletons
    {
        ...
        // NOTE: this implementation is configured for a local Redis store; read the server hostname from a configuration file for other applications.
        ...
        public static async Task<RedisClient> CreateNewRedisClientAsync()
        {
